                        ...
                        <div class="relative">
                            ...
                            <div class="-mt-12 pt-12">
                                <div
                                    ...
                                    <!-- product:title -->
                                    <h1 class="font-bold text-xl text-foreground">قالب فروشگاهی React و Next</h1>

                                    <!-- product:excerpt -->
                                    <p class="text-sm text-muted">
                                        قالب حرفه‌ای فروشگاهی با React و Next.js که شامل تمامی امکانات مدرن
                                        برای راه‌اندازی فروشگاه آنلاین است. این قالب با طراحی ریسپانسیو و
                                        بهینه‌سازی SEO آماده استفاده فوری می‌باشد.
                                    </p>
                                </div>
                                    ...
                                    <div class="grid lg:grid-cols-4 grid-cols-2 gap-5">
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                <span class="font-bold text-sm text-foreground line-clamp-1">قالب /
                                                    پلاگین</span>
                                            </div>
                                        </div>
                                        <div
                                                ...
                                                <ul
                                                    ...
                                                    <li>
                                                        <button type="button"
                                                            ...
                                                            <span
                                                                class="font-semibold text-sm whitespace-nowrap">ویژگی‌ها</span>
                                                        </button>
                                                    </li><!-- end tabs:list:item -->
                                                    ...
                                                    <div class="w-full" x-data="{ open: true }">
                                                        ...
                                                        <button type="button"
                                                            ...
                                                            <span class="flex items-center gap-3 text-right">
                                                                ...
                                                                <span class="font-semibold text-xs"> ویژگی‌های اصلی</span>
                                                            </span>
