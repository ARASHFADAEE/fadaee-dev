...
<head>
    ...
    <link rel="icon" type="image/svg+xml" href="<?php echo ARASH_THEME_DIR ?>/assets/images/favicon.svg" />
    <link rel="stylesheet" href="<?php echo ARASH_THEME_DIR ?>/assets/css/dependencies/swiper-bundle.min.css" />
...
<body>
                            ...
                            <div class="swiper-wrapper">
                                    ...
                                    <div class="relative">
                                        <div class="relative z-10">
                                            <a href="./course-detail.html" class="block">
                                                <img src="<?php echo ARASH_THEME_DIR ?>/assets/images/courses/01.jpg" class="max-w-full rounded-3xl"
                                                    alt="..." />
                                            </a>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="relative">
                                        <div class="relative z-10">
                                            <a href="./course-detail.html" class="block">
                                                <img src="<?php echo ARASH_THEME_DIR ?>/assets/images/courses/02.jpg" class="max-w-full rounded-3xl"
                                                    alt="..." />
                                            </a>
                                            <a href="./course-category.html"
                                                class="absolute left-3 top-3 h-11 inline-flex items-center justify-center gap-1 bg-black/20 rounded-full text-white transition-all hover:opacity-80 px-4">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="relative">
                                        <div class="relative z-10">
                                            <a href="./course-detail.html" class="block">
                                                <img src="<?php echo ARASH_THEME_DIR ?>/assets/images/courses/03.jpg" class="max-w-full rounded-3xl"
                                                    alt="..." />
                                            </a>
                                            <a href="./course-category.html"
                                                class="absolute left-3 top-3 h-11 inline-flex items-center justify-center gap-1 bg-black/20 rounded-full text-white transition-all hover:opacity-80 px-4">
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="relative">
                                        <div class="relative z-10">
                                            <a href="./course-detail.html" class="block">
                                                <img src="<?php echo ARASH_THEME_DIR ?>/assets/images/courses/04.jpg" class="max-w-full rounded-3xl"
                                                    alt="..." />
                                            </a>
                                            <a href="./course-category.html"
                                                class="absolute left-3 top-3 h-11 inline-flex items-center justify-center gap-1 bg-black/20 rounded-full text-white transition-all hover:opacity-80 px-4">
                            ...
                            <div class="grid sm:grid-cols-2 grid-cols-1 gap-x-5 gap-y-8 space-y-8">
                                <div class="space-y-5">
                                    ...
                                    <div class="relative bg-background rounded-xl p-4">
                                        <div class="relative mb-3 z-20">
                                            <a href="./article-detail.html" class="block">
                                                <img src="<?php echo ARASH_THEME_DIR ?>/assets/images/courses/01.jpg" class="max-w-full rounded-xl"
                                                    alt="..." />
                                            </a>
                                            <button type="button"
                                    ...
                                    <div class="relative bg-background rounded-xl p-4">
                                        <div class="relative mb-3 z-20">
                                            <a href="./article-detail.html" class="block">
                                                <img src="<?php echo ARASH_THEME_DIR ?>/assets/images/courses/02.jpg" class="max-w-full rounded-xl"
                                                    alt="..." />
                                            </a>
                                            <button type="button"
                                                class="absolute left-3 -bottom-3 w-9 h-9 inline-flex items-center justify-center bg-secondary rounded-full shadow-xl text-muted transition-colors hover:text-red-500 z-10">
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div class="relative bg-background rounded-xl p-4">
                                        <div class="relative mb-3 z-20">
                                            <a href="./article-detail.html" class="block">
                                                <img src="<?php echo ARASH_THEME_DIR ?>/assets/images/courses/03.jpg" class="max-w-full rounded-xl"
                                                    alt="..." />
                                            </a>
                                            <button type="button"
                                                class="absolute left-3 -bottom-3 w-9 h-9 inline-flex items-center justify-center bg-secondary rounded-full shadow-xl text-muted transition-colors hover:text-red-500 z-10">
                                    ...
                                    <div class="relative bg-background rounded-xl p-4">
                                        <div class="relative mb-3 z-20">
                                            <a href="./article-detail.html" class="block">
                                                <img src="<?php echo ARASH_THEME_DIR ?>/assets/images/courses/04.jpg" class="max-w-full rounded-xl"
                                                    alt="..." />
                                            </a>
                                            <button type="button"
                                                class="absolute left-3 -bottom-3 w-9 h-9 inline-flex items-center justify-center bg-secondary rounded-full shadow-xl text-muted transition-colors hover:text-red-500 z-10">
    ...
    <script src="<?php echo ARASH_THEME_DIR ?>/assets/js/dependencies/alpinejs.min.js"></script>
    <script src="<?php echo ARASH_THEME_DIR ?>/assets/js/dependencies/swiper-bundle.min.js"></script>
    <script src="<?php echo ARASH_THEME_DIR ?>/assets/js/dependencies/plyr.min.js"></script>
    <script src="<?php echo ARASH_THEME_DIR ?>/assets/js/app.js"></script>
</body>
